...
contract EffingToken is Context, IERC20, Ownable {
    using Address for address;
    address payable public marketingWalletAddress = payable(0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a); // Marketing Wallet Address
    address payable public reserveWalletAddress = payable(0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a); // Marketing Wallet Address
    address payable public charityWalletAddress = payable(0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a); // charity Wallet Address
    address payable public devWalletAddress = payable(0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a); // dev Wallet Address
    ...
    string private constant _name = "EffingToken";
    string private constant _symbol = "EFFINGTOKEN";
    ...
    constructor () {
        address _owner = 0xa1003314FB6aDd8D8DF217A9CBF63eaBe892A77a;
